...
if (catalogo) {
  ...
  var quantidade = Math.floor(Math.random() * 20);
...
var selectedCount = 0;
quant = document.querySelector('#quant-carrinho')
...
const nomesVinhos = document.querySelectorAll('.nome-vinho h2');
nomesVinhos.forEach(element => typeMachine(element));

function typeMachine(element) {
